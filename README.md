...
- During analyzation of feature importance it was obvious that the models favoured offensive players, due to high importance in metrics that are primarily relevant to attackers
  (e.g. expected goals or expected assists)
